...
public class XOButton extends JButton implements ActionListener
{
	...
	public XOButton()
	{
		X = new ImageIcon(this.getClass().getResource("/src/resource/tic-tac-toe-clipart-X.png"));
		O = new ImageIcon(this.getClass().getResource("/src/resource/tic-tac-toe-clipart-O.png"));
